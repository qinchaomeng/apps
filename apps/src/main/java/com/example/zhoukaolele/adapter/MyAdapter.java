...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.Holder> {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.rca, null);
...
TextView textView1,textView2;
        public Holder(@NonNull View itemView) {
            super(itemView);
            imageView=itemView.findViewById(R.id.imagec1);
            textView1=itemView.findViewById(R.id.textc1);
            textView2=itemView.findViewById(R.id.textc11);
        }
    }
}
